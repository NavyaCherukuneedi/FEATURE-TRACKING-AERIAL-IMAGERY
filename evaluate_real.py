...
EvalDatasetConfigDict = {
    EvalDatasetType.EC: {"dt": 0.010, "root_dir": "./"},
    EvalDatasetType.EDS: {"dt": 0.5, "root_dir": "D:\projects\FEATURE-TRACKING-AERIAL-IMAGERY"},
}

EVAL_DATASETS = [
    ("aligned_timestamps_data_dl_town01_day_5_100", EvalDatasetType.EDS),
...
def track(cfg):
    ...
    for seq_name, seq_type in EVAL_DATASETS:
        ...
        gt_features_path = str(Path(cfg.gt_path) / "rgb_day_Town3.txt")
