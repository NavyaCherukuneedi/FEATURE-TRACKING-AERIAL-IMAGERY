...
sequence_name = "aligned_timestamps_data_dl_town01_day"
corrected_image_dir = f"./{sequence_name}/images_corrected"
image_ts_path = f"./{sequence_name}/images_timestamps.txt"
corrected_events_path = (
    f"./{sequence_name}/events_corrected.h5"
)
dt_event_slice = 500
